...
const PRODUCTS = [
  ...
  { id: 7, name: 'Рушникосушка Mario', desc: 'Електрична рушникосушка з таймером.', price: 3800, category: 'accessories', image: 'https://on-za.ua/wa-data/public/shop/products/02/36/23602/images/35788/35788.970.jpg', specs: ['Тип: Електрична', 'Матеріал: Нержавіюча сталь', 'Таймер: Є'] },
