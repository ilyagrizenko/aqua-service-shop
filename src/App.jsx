...
const PRODUCTS = [
  ...
  { id: 6, name: 'Ванна акрилова Ravak', desc: 'Асиметрична ванна, економить місце, довго тримає тепло.', price: 15600, category: 'bath', image: 'https://images.prom.ua/735070230_w1280_h640_735070230.jpg', specs: ['Розмір: 160х95 см', 'Матеріал: Литий акрил', 'Об\'єм: 210 літрів'] },
