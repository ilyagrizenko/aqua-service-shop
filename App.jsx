...
const PRODUCTS = [
  ...
  { id: 8, name: 'Сифон для мийки Franke', desc: 'Простий в очищенні сифон.', price: 850, category: 'siphon', image: '/images/sifon.png', specs: ['Діаметр випуску: 3.5 дюйма', 'Матеріал: Пластик', 'Перелив: Є'] },
